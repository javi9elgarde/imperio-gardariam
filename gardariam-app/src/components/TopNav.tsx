  ...
  return (
    <nav className="glass-panel fixed left-1/2 top-4 z-[900] flex -translate-x-1/2 items-center gap-1 rounded-full px-2.5 py-1.5">
      <a
        ...
        title="Volver al Hub"
        className="font-display mr-1 rounded-full px-2.5 py-1.5 text-[0.58rem] uppercase tracking-[0.1em] text-parchment-faint transition-colors hover:bg-imperial-gold/10 hover:text-imperial-gold-bright"
      >
        ← Hub
      </a>
      <div className="mr-1 h-5 w-px bg-imperial-gold/25" />
      <button
